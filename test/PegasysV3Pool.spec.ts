...
describe('PegasysV3Pool', () => {
  ...
  // https://github.com/Pegasys/pegasys-v3-core/issues/214
  ...
  describe('#lock', () => {
    ...
    it('cannot reenter from swap callback', async () => {
      const reentrant = (await deployContract('TestPegasysV3ReentrantCallee')) as TestPegasysV3ReentrantCallee
  ...
  describe('swap underpayment tests', () => {
    ...
    beforeEach('deploy swap test', async () => {
      underpay = (await deployContract('TestPegasysV3SwapPay')) as TestPegasysV3SwapPay
